...
function game(data)
{
	...
	document.getElementById("terminal").innerHTML = "<p><strong>¡Bienvenidos a ENTIerrame!</strong> El juego de terror de terror definitivo.</p>";
...
fetch("https://aymerichrogerguardia.github.io/game.json").then(response => response.json()).then(data => game(data));
